...
def merge_dt_list(list):
    merged_data = {
        "info": {"year": 2023, "version": "1", "date_created": "no need record"},
        "images": [],
        "annotations": [],
        "licenses": [{"id": 1, "name": "Unknown", "url": ""}],
        "categories": [{"id": 1, "name": "hd", "supercategory": ""}],
    }
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--predict-directory",
        type=str,
        default="divide_and_conquer/pseudo_masks",
        help="predict-directory",
    )
    ...
    mAP_copypaste = f"{ap[0]*100:.2f} {ap[1]*100:.2f} {ap[2]*100:.2f} {ap[3]*100:.2f} {ap[4]*100:.2f} {ap[5]*100:.2f}"
    mAR_copypaste = f"{ar[0]*100:.2f} {ar[1]*100:.2f} {ar[3]*100:.2f} {ar[4]*100:.2f} {ar[5]*100:.2f} {ar[2]*100:.2f}"
