...
_PREDEFINED_SPLITS_COCO_SEMI["coco_semi"] = {
    ...
    "coco_semi_1perc": (
        "coco/train2017",
        "coco/annotations/1perc_instances_train2017.json",
    ),
    "coco_semi_2perc": (
        "coco/train2017",
        "coco/annotations/2perc_instances_train2017.json",
    ),
    "coco_semi_5perc": (
        "coco/train2017",
        "coco/annotations/5perc_instances_train2017.json",
    ),
    "coco_semi_10perc": (
        "coco/train2017",
        "coco/annotations/10perc_instances_train2017.json",
    ),
    "coco_semi_20perc": (
        "coco/train2017",
        "coco/annotations/20perc_instances_train2017.json",
    ),
    "coco_semi_30perc": (
        "coco/train2017",
        "coco/annotations/30perc_instances_train2017.json",
    ),
    "coco_semi_40perc": (
        "coco/train2017",
        "coco/annotations/40perc_instances_train2017.json",
    ),
    "coco_semi_50perc": (
        "coco/train2017",
        "coco/annotations/50perc_instances_train2017.json",
    ),
    "coco_semi_60perc": (
        "coco/train2017",
        "coco/annotations/60perc_instances_train2017.json",
    ),
    "coco_semi_80perc": (
        "coco/train2017",
        "coco/annotations/80perc_instances_train2017.json",
    ),
}
...
_PREDEFINED_SPLITS_IMAGENET["imagenet"] = {
    ...
    "imagenet_train": (
        "imagenet/train",
        "imagenet/annotations/imagenet_train_fixsize480_tau0.15_N3.json",
    ),
    # self-training round 1
    "imagenet_train_r1": (
        "imagenet/train",
        "imagenet/annotations/cutler_imagenet1k_train_r1.json",
    ),
    # self-training round 2
    "imagenet_train_r2": (
        "imagenet/train",
        "imagenet/annotations/cutler_imagenet1k_train_r2.json",
    ),
    # self-training round 3
    "imagenet_train_r3": (
        "imagenet/train",
        "imagenet/annotations/cutler_imagenet1k_train_r3.json",
    ),
}
...
_PREDEFINED_SPLITS_CROSSDOMAIN["cross_domain"] = {
    "cls_agnostic_clipart": (
        "clipart/",
        "clipart/annotations/traintest_cls_agnostic.json",
    ),
    "cls_agnostic_watercolor": (
        "watercolor/",
        "watercolor/annotations/traintest_cls_agnostic.json",
    ),
...
_PREDEFINED_SPLITS_LVIS["lvis"] = {
    "cls_agnostic_lvis": (
        "coco/",
        "coco/annotations/lvis1.0_cocofied_val_cls_agnostic.json",
    ),
}
...
_PREDEFINED_SPLITS_OBJECTS365["objects365"] = {
    "cls_agnostic_objects365": (
        "objects365/val",
        "objects365/annotations/zhiyuan_objv2_val_cls_agnostic.json",
    ),
}
...
_PREDEFINED_SPLITS_OpenImages["openimages"] = {
    "cls_agnostic_openimages": (
        ...
        "openImages/annotations/openimages_val_cls_agnostic.json",
    ),
}
...
_PREDEFINED_SPLITS_UVO["uvo"] = {
    "cls_agnostic_uvo": (
        "uvo/all_UVO_frames",
        "uvo/annotations/val_sparse_cleaned_cls_agnostic.json",
    ),
}
